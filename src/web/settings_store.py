...
SETTINGS_SCHEMA: list[dict] = [
    ...
    {"key": "telegram_llm_fallback_enabled", "label": "LLM-фолбэк парсинга (если регулярки не распознали)", "group": "Telegram сигналы", "type": "bool",
     "description": "Если регулярки не смогли разобрать сообщение канала — пробовать распознать его через Anthropic API. Требует Anthropic API key ниже."},
    {"key": "anthropic_api_key", "label": "Anthropic API key", "group": "Telegram сигналы", "type": "secret",
     "description": "Ключ Anthropic API для LLM-фолбэка парсинга сигналов."},
